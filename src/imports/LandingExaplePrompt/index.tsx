import svgPaths from "./svg-gag5tvhde8";
...
function StartIcon() {
  return (
    <div className="content-stretch flex items-center pr-[4px] relative shrink-0" data-name="Start icon">
      <div className="relative shrink-0 size-[24px]" data-name="♣️ Start Icon">
        <div className="absolute inset-[16.67%_33.33%_16.67%_29.17%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 15.9998">
            <g id="Vector">
              <path clipRule="evenodd" d={svgPaths.p2982e600} fill="var(--fill-0, #4E4EE2)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p1fe4d800} fill="var(--fill-0, #4E4EE2)" fillRule="evenodd" />
            </g>
          </svg>
        </div>
      </div>
...
function Wrapper() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-[473px]" data-name="Wrapper">
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Link">
        <StartIcon />
        <p className="[word-break:break-word] font-['Hanken_Grotesk:Bold',sans-serif] font-bold leading-[1.4] relative shrink-0 text-[#4e4ee2] text-[16px] whitespace-nowrap" style={{ fontFeatureSettings: '"ss01", "ss03"' }}>
          Terug
        </p>
      </div>
      <p className="[word-break:break-word] font-['ABC_ROM:Bold',sans-serif] leading-[1.05] not-italic relative shrink-0 text-[#1f1e2f] text-[21px] whitespace-nowrap">{`Kleding & textiel`}</p>
    </div>
  );
}
...
function Section() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Section">
      <Wrapper />
      <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Link List - Emphasis (S)">
        <div className="bg-[#f1f1f2] relative rounded-[6px] shrink-0 w-full" data-name=".x / Link - Emphasis">
          ...
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[12px] items-center px-[16px] py-[12px] relative size-full">
              <p className="[word-break:break-word] flex-[1_0_0] font-['Hanken_Grotesk:Bold',sans-serif] font-bold leading-[1.4] min-w-px relative text-[#4e4ee2] text-[16px]" style={{ fontFeatureSettings: '"ss01", "ss03"' }}>
        ...
        <div className="bg-[#f1f1f2] relative rounded-[6px] shrink-0 w-full" data-name=".x / Link - Emphasis">
          ...
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[12px] items-center px-[16px] py-[12px] relative size-full">
              <p className="[word-break:break-word] flex-[1_0_0] font-['Hanken_Grotesk:Bold',sans-serif] font-bold leading-[1.4] min-w-px relative text-[#4e4ee2] text-[16px]" style={{ fontFeatureSettings: '"ss01", "ss03"' }}>{`Sportkleding, zo'n 5 stuks`}</p>
              <div className="relative shrink-0 size-[16px]" data-name="▶️ Chevron">
                <div className="absolute inset-[10.16%_25.78%_10.16%_28.91%]" data-name="Vector">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.25 12.7499">
                    <g id="Vector">
        ...
        <div className="bg-[#f1f1f2] relative rounded-[6px] shrink-0 w-full" data-name=".x / Link - Emphasis">
          ...
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[12px] items-center px-[16px] py-[12px] relative size-full">
              <p className="[word-break:break-word] flex-[1_0_0] font-['Hanken_Grotesk:Bold',sans-serif] font-bold leading-[1.4] min-w-px relative text-[#4e4ee2] text-[16px]" style={{ fontFeatureSettings: '"ss01", "ss03"' }}>{`Kinderpyjama's voor mijn zus`}</p>
              <div className="relative shrink-0 size-[16px]" data-name="▶️ Chevron">
                <div className="absolute inset-[10.16%_25.78%_10.16%_28.91%]" data-name="Vector">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.25 12.7499">
                    <g id="Vector">
...
export default function LandingExaplePrompt() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[72px] items-center relative size-full" data-name="Landing - Exaple prompt">
