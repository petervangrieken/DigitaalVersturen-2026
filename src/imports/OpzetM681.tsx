import svgPaths from "./svg-dc2luhej2p";
...
function TitlePage() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start max-w-[914px] relative shrink-0 w-full whitespace-pre-wrap" data-name="Title page">
      <p className="font-['ABC_ROM:Bold',sans-serif] leading-[0.9] max-w-[532px] not-italic relative shrink-0 text-[#001a73] text-[32px] tracking-[-1px] w-full">Titel</p>
  ...
  return (
    <div className="absolute inset-[5.33%]" data-name="Object">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50.0267 50.0267">
        <g id="Object">
          <mask height="51" id="mask0_2001_4336" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="51" x="0" y="0">
            <path d={svgPaths.p3f9e3a00} fill="var(--fill-0, white)" id="Rectangle" stroke="var(--stroke-0, white)" strokeWidth="0.373333" />
          </mask>
          <g mask="url(#mask0_2001_4336)">
...
export default function OpzetM() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center relative size-full" data-name="Opzet (M) - 681">
      <Frame1 />
    </div>
  );
}