import svgPaths from "./svg-3mwcus11o3";

function Object() {
  return (
    <div className="absolute inset-[5.33%]" data-name="Object">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42.8801 42.88">
        <g id="Object">
          <mask height="43" id="mask0_6012_415" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="43" x="0" y="0">
            <path d={svgPaths.p339a8c00} fill="var(--fill-0, white)" id="Rectangle" stroke="var(--stroke-0, white)" strokeWidth="2" />
          </mask>
          <g mask="url(#mask0_6012_415)">
            <rect fill="var(--fill-0, white)" height="42.88" id="Rectangle_2" width="42.88" y="2.86102e-06" />
            <path clipRule="evenodd" d={svgPaths.p11575b80} fill="var(--fill-0, #E75204)" fillRule="evenodd" id="Rectangle (Stroke)" />
            <g id="illustration">
              ...
              <path d={svgPaths.p15764600} fill="var(--fill-0, #E75204)" />
              ...
              <path d={svgPaths.p3e39ad00} fill="var(--fill-0, #E75204)" />
              <path d={svgPaths.p1fe7600} fill="var(--fill-0, #E75204)" />
              <path d={svgPaths.p19e43400} fill="var(--fill-0, #E75204)" />
              ...
              <path d={svgPaths.p15764600} stroke="var(--stroke-0, #E75204)" />
              ...
              <path d={svgPaths.p3e39ad00} stroke="var(--stroke-0, #E75204)" />
              <path d={svgPaths.p1fe7600} stroke="var(--stroke-0, #E75204)" />
              <path d={svgPaths.p19e43400} stroke="var(--stroke-0, #E75204)" />
