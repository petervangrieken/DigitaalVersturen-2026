import svgPaths from "./svg-456tj19yat";
...
function HeaderTopRightLinkAndIcon() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Header Top Right / Link and icon">
      <LinkMenuItem />
      <ShoppingCartM />
    </div>
  );
...
function Container() {
  return (
    <div className="h-[44px] max-w-[1104px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex items-start justify-between max-w-[inherit] pr-[16px] pt-[8px] relative size-full">
        <HeaderTabs />
        <Right />
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Logo">
          <path d={svgPaths.p10868300} fill="var(--fill-0, #E75204)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function HeaderBottom() {
  return (
    <div className="relative shrink-0 w-full" data-name="Header Bottom">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[40px] py-[12px] relative w-full">
          <Container1 />
        </div>
      </div>
    </div>
...
function BreadcrumbWrapper() {
  return (
    <div className="max-w-[1104px] relative shrink-0 w-full" data-name="Breadcrumb wrapper">
      <div className="content-stretch flex flex-col items-start max-w-[inherit] pl-[40px] py-[12px] relative w-full">
        <BreadcrumbsL />
      </div>
    </div>
  );
...
function HeaderGeneric() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="Header Generic">
      <HeaderTop />
      <HeaderBottom />
      <BreadcrumbWrapper />
    </div>
...
export default function TextPageM() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[56px] items-center relative size-full" data-name="Text page (M)">
      <HeaderAutosize />
      <ContentContainer />
    </div>
  );
