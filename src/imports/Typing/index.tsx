import svgPaths from "./svg-vh0my3gljf";
...
function Actions() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="Actions">
      ...
      <p className="[word-break:break-word] flex-[1_0_0] font-['Hanken_Grotesk:Regular',sans-serif] font-normal leading-[1.5] min-w-px relative text-[#1f1e2f] text-[16px]" style={{ fontFeatureSettings: '"ss01", "ss03"' }}>{`Ik wil sportkleding, zo'n 5 stuks|`}</p>
      <Right />
    </div>
  );
}
...
export default function Typing() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[72px] items-center relative size-full" data-name="Typing">
